...
```{r}
#| label: tbl1
#| tbl-cap: "Table 1: Known beaver dams and log jams within Takla Nation traditional territory. Beaver dams and log jams are not actively being targeted by this plan."
#| warning: false
#| echo: false
#| results: asis
...
data <- read.csv("data/tbl1.csv", check.names=FALSE)
ft <- flextable(data)
